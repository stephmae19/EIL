        ...
        try:
            ...
            for x in range(sheet.get_width()):
                for y in range(sheet.get_height()):
                    ...
                    # --- THE 3-TIER RULE FOR PURE BLACK SILHOUETTES ---
                    
                    # RULE 1: Glowing Eyes & Blast
                    # If it is bright white/blue, leave it completely alone.
                    if r > 80 or g > 80 or b > 80:
                        continue 
                        
                    # RULE 2: The Core Body
                    # If it is pitch black (RGB 0 to 15), force it to be Opaque Black.
                    # This ensures the inside of the monster is NOT transparent.
                    elif r <= 15 and g <= 15 and b <= 15:
                        sheet.set_at((x, y), (0, 0, 0, 255)) 
                        
                    # RULE 3: The Dark Grey Background
                    # Anything left over (RGB 16 to 79) is the muddy JPEG noise box.
                    # Destroy it completely.
                    else:
                        sheet.set_at((x, y), (0, 0, 0, 0)) # 100% Transparent

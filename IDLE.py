...
IDLE_FILENAME = 'player_idle.png'  # Changed from .py to .png

# Grid details (Assuming both are 5x5)
ROWS, COLS = 5, 5
...
class Player(pygame.sprite.Sprite):
    ...
    def load_sprite_sheet(self, filename, rows, cols):
        ...
        try:
            ...
            sheet.set_colorkey((0, 0, 0)) # Transparency for black backgrounds
    ...
    def animate(self):
        ...
        # Reset index if the state changes (e.g., from walk to idle)
        ...
        # Flip horizontally if moving/facing left

...
class Enemy(pygame.sprite.Sprite):
    ...
    def load_frames(self, filename, rows, cols):
        ...
        try:
            ...
            # --- THE "AGGRESSIVE BLACK PAINT" ALGORITHM ---
            # Instead of guessing what is background, we will guess what is NOT background.
            # We assume the background is very dark gray (r,g,b around 20-30).
            # The body outline is slightly lighter.
            ...
            for x in range(sheet.get_width()):
                for y in range(sheet.get_height()):
                    ...
                    # 1. Keep the very brightest pixels (eyes, blast)
                    if r > 180 and g > 180 and b > 180:
                        pass # Keep it bright!
                        
                    # 2. Is it dark enough to be the background? 
                    # If it's very dark gray, make it completely transparent.
                    elif r < 40 and g < 40 and b < 40:
                        pixel_array[x, y] = (0, 0, 0, 0)
                        
                    # 3. If it's between dark gray and bright white...
                    # It MUST be the body or the outline. FORCE IT TO BE SOLID PURE BLACK.
                    else:
                        pixel_array[x, y] = (0, 0, 0, 255) # Opaque, pitch black
